"""URL routes for the core module — auth, profile, and agent tokens."""
...
urlpatterns = [
    ...
    path(
        ...
        AgentTokenGenerateView.as_view(),
        name='agent-token-generate',
    ),
    path(
        'agent-token/list/',
    ...
    path(
        'agent-token/<int:token_id>/revoke/',
        AgentTokenRevokeView.as_view(),
